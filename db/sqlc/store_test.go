...
func TestTransferTx(t *testing.T) {
	...
	for i := 0; i < n; i++ {
		...
		diff1 := account1.Balance - fromAccount.Balance // amount of money that's going out from account1
		diff2 := toAccount.Balance - account2.Balance   // amount of money that's going in to account2
